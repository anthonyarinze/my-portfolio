        ...
        {isAboveMediumScreens ? (
          ...
          >
            <img
              alt="profile"
              src={ProfileImage}
              className="hover:filter hover:saturate-150 
          ...
          <img
            alt="profile"
            src={ProfileImage}
            className="py-10 hover:filter hover:saturate-150 
              transition duration-500 z-10 w-full max-w-[400px] 
              md:max-w-[600px]"
          />
        )}
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          <AnchorLink
           ...
           rounded-sm py-3 px-7 font-semibold hover:bg-blue
          ...
          >
            <div
             ...
             transition duration-500 w-full h-full flex 
